...
export const listGroups = async (
  ...
  return customFetch<QuestionGroup[]>(getListGroupsUrl(id), {
    ...options,
    method: "GET",
  });
};
...
export const getListGroupsQueryKey = (id: string) => {
  return [`/api/forms/${id}/groups`] as const;
};
...
>(
  ...
  const queryFn: QueryFunction<Awaited<ReturnType<typeof listGroups>>> = ({
    signal,
  }) => listGroups(id, { signal, ...requestOptions });
 ...
 */
export const getCreateGroupUrl = (id: string) => {
  return `/api/forms/${id}/groups`;
};
...
export const createGroup = async (
  ...
  return customFetch<QuestionGroup>(getCreateGroupUrl(id), {
    ...options,
    method: "POST",
    headers: { "Content-Type": "application/json", ...options?.headers },
...
>(options?: {
  mutation?: UseMutationOptions<
    ...
    TError,
    { id: string; data: BodyType<CreateGroupBody> },
    TContext
  >;
  request?: SecondParameter<typeof customFetch>;
}): UseMutationOptions<
...
> => {
  ...
  > = (props) => {
    ...
    return createGroup(id, data, requestOptions);
  };
 ...
 */
export const getUpdateGroupUrl = (formId: string, groupId: string) => {
  return `/api/forms/${formId}/groups/${groupId}`;
};
...
export const updateGroup = async (
  ...
  return customFetch<QuestionGroup>(getUpdateGroupUrl(formId, groupId), {
    ...options,
    method: "PUT",
    headers: { "Content-Type": "application/json", ...options?.headers },
...
>(options?: {
  mutation?: UseMutationOptions<
    ...
    TError,
    { formId: string; groupId: string; data: BodyType<UpdateGroupBody> },
    TContext
  >;
  request?: SecondParameter<typeof customFetch>;
}): UseMutationOptions<
...
> => {
  ...
  const mutationFn: MutationFunction<
    ...
    { formId: string; groupId: string; data: BodyType<UpdateGroupBody> }
  > = (props) => {
    const { formId, groupId, data } = props ?? {};

    return updateGroup(formId, groupId, data, requestOptions);
  };
 ...
 */
export const getDeleteGroupUrl = (formId: string, groupId: string) => {
  return `/api/forms/${formId}/groups/${groupId}`;
};
...
export const deleteGroup = async (
  ...
  return customFetch<void>(getDeleteGroupUrl(formId, groupId), {
    ...options,
    method: "DELETE",
  });
};
...
> => {
  ...
  const mutationFn: MutationFunction<
    ...
    { formId: string; groupId: string }
  > = (props) => {
    const { formId, groupId } = props ?? {};

    return deleteGroup(formId, groupId, requestOptions);
  };
