...
export default function Signup() {
  ...
  const passwordStrength = (() => {
    ...
    if (password.length < 10) return { label: "Fair", color: "bg-amber-400", width: "w-2/4" };
    if (!/[^a-zA-Z0-9]/.test(password)) return { label: "Good", color: "bg-chart-2", width: "w-3/4" };
    ...
    <div className="min-h-screen bg-background flex">
      ...
      <div className="hidden lg:flex w-[420px] flex-shrink-0 flex-col justify-between bg-sidebar border-r border-border p-10">
        ...
        <div className="space-y-6">
          <div>
            <h2 className="text-2xl font-bold text-foreground mb-2">Build better forms,<br />get better insights.</h2>
            <p className="text-sm text-muted-foreground leading-relaxed">
              Join thousands of teams who use Formly to collect data, automate workflows, and understand their audience.
            </p>
          </div>
      ...
      <div className="flex-1 flex items-center justify-center px-6 py-12">
        <div className="w-full max-w-sm">
          ...
          <p className="text-sm text-muted-foreground mb-8">Start building forms in minutes. Free forever.</p>
          ...
          <div className="relative mb-6">
            ...
            <div className="relative flex justify-center">
              <span className="px-3 bg-background text-xs text-muted-foreground">or sign up with email</span>
            </div>
          </div>
            ...
            <div>
              ...
              {passwordStrength && (
                <div className="mt-2">
                  ...
                  <p className="text-xs text-muted-foreground mt-1">{passwordStrength.label} password</p>
                </div>
              )}
            </div>
